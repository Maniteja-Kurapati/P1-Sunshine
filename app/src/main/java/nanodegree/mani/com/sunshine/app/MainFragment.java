...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //List of values
        String[] fakeData = {"Today-Sunny-88/56","Tomorrow-Cloudy-55/24","Monday-rainy-84/67",
                "Tuesday-sunny-90/72","Wednesday-sunny-84/54",
                "Thursday-cloudy-88/58", "Friday-winds-87/56",
        ...
        forecastListView.setAdapter(stringArrayAdapter);
